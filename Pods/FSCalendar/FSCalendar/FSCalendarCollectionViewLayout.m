...
- (void)prepareLayout
{
    ...
    self.estimatedItemSize = ({
        ...
        CGSize size = CGSizeMake(width, height);      //Vivek
...
{
    // Clipping
//    rect = CGRectIntersection(rect, CGRectMake(8.0, 0, self.contentSize.width, self.contentSize.height));
...
//            CGRect frame = CGRectMake(x + 8.0, y, height, height);
...
//            attributes.frame = CGRectMake(x + 8.0, y, height, height);
            attributes.frame = CGRectMake(x + 0.0, y, width, height);
